...
DEBUG = False
#this means will go to our personal 404.html page
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], #this means go to root directory and find templates folder to set defult global template 
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
